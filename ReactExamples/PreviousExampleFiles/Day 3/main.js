/* Sudo API functionality for predetermined data */ 
...
/* Functional Component to monitor State of Active Friends */
...
/* Functional Component to monitor State of Inactive Friends */
...
/* Class Component that houses the embodiment of our Application  */
...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    API.fetchFriends().then((friends) => {
      this.setState({
        friends, //example of ES6 shorthand object notation method could also be friends: friends, 
        loading: false
      })
    })
